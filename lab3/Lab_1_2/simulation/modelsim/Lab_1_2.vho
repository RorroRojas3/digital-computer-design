...
-- iready	=>  Location: PIN_AC25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[3]	=>  Location: PIN_AF13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[4]	=>  Location: PIN_AA20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[5]	=>  Location: PIN_W21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[6]	=>  Location: PIN_AF18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[7]	=>  Location: PIN_D4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- oready	=>  Location: PIN_AA14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ovalid	=>  Location: PIN_AG17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[0]	=>  Location: PIN_AB28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[1]	=>  Location: PIN_AC28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[2]	=>  Location: PIN_AA28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[3]	=>  Location: PIN_AA30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[4]	=>  Location: PIN_E1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[5]	=>  Location: PIN_AB30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[6]	=>  Location: PIN_G13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dataout[7]	=>  Location: PIN_AC14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[1]	=>  Location: PIN_V25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[2]	=>  Location: PIN_W25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- datain[0]	=>  Location: PIN_AC29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clock	=>  Location: PIN_AB27,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- resetn	=>  Location: PIN_AD29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ivalid	=>  Location: PIN_AE29,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \trafficColors|Selector3~0_combout\ = ( \trafficColors|trafficColors.left_turn~q\ & ( ((!\datain[0]~input_o\ & !\datain[1]~input_o\)) # (\trafficColors|trafficColors.green~q\) ) ) # ( !\trafficColors|trafficColors.left_turn~q\ & ( 
...
-- Equation(s):
-- \trafficColors|Selector5~0_combout\ = ( \trafficColors|trafficColors.yellow~q\ & ( \datain[0]~input_o\ ) ) # ( !\trafficColors|trafficColors.yellow~q\ & ( (!\datain[1]~input_o\ & (\datain[0]~input_o\ & (!\datain[2]~input_o\ & 
-- \trafficColors|trafficColors.red~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000100000000000000010000000110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \trafficColors|Selector1~0_combout\ = ( \trafficColors|trafficColors.red~q\ & ( \trafficColors|trafficColors.right_turn~q\ ) ) # ( !\trafficColors|trafficColors.red~q\ & ( \trafficColors|trafficColors.right_turn~q\ ) ) # ( 
-- \trafficColors|trafficColors.red~q\ & ( !\trafficColors|trafficColors.right_turn~q\ & ( (!\datain[0]~input_o\ & (((!\datain[1]~input_o\ & !\datain[2]~input_o\)) # (\trafficColors|trafficColors.yellow~q\))) ) ) ) # ( !\trafficColors|trafficColors.red~q\ & 
-- ( !\trafficColors|trafficColors.right_turn~q\ & ( (!\datain[0]~input_o\ & \trafficColors|trafficColors.yellow~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011001100100000001100110011111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_datain[1]~input_o\,
	datab => \ALT_INV_datain[0]~input_o\,
	datac => \ALT_INV_datain[2]~input_o\,
	datad => \trafficColors|ALT_INV_trafficColors.yellow~q\,
	datae => \trafficColors|ALT_INV_trafficColors.red~q\,
	dataf => \trafficColors|ALT_INV_trafficColors.right_turn~q\,
...
-- Equation(s):
-- \trafficColors|Selector2~0_combout\ = ( \trafficColors|trafficColors.left_turn~q\ & ( (\datain[1]~input_o\) # (\datain[0]~input_o\) ) ) # ( !\trafficColors|trafficColors.left_turn~q\ & ( (!\datain[2]~input_o\ & (\datain[1]~input_o\ & 
-- \trafficColors|trafficColors.red~q\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001100000000000000110001011111010111110101111101011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
