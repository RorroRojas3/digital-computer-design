...
-- ***************************************************************************
-- Generated on "09/18/2017 14:39:59"
                                                            
-- Vhdl Test Bench template for design  :  binaryToDecimal
-- 
...
ENTITY binaryToDecimal_vhd_tst IS
END binaryToDecimal_vhd_tst;
ARCHITECTURE binaryToDecimal_arch OF binaryToDecimal_vhd_tst IS
-- constants                                                 
-- signals                                                   
...
BEGIN                                                         
        -- Will set the input V to value of 0 on binary and wait 10 ns  
		  ...
		  V <= "0011";
		  WAIT FOR 10ns;
		  -- Will set the input V to value of 7 on binary and wait 10 ns
		  V <= "0111";
		  WAIT FOR 10ns;
